...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: HomeCardsWidget.routeName,
          path: HomeCardsWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'home-cards')
              : HomeCardsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: KeysWidget.routeName,
          path: KeysWidget.routePath,
          builder: (context, params) => KeysWidget(),
        ),
        FFRoute(
